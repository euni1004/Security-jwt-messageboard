...
public class CommentService {
    ...
    public CommentReturnDto commentPost(CommentRequestDto requestDto){
        ...
        Comment comment = new Comment(requestDto.getPostId(),member.getNickname(),requestDto.getComment());
    ...
    public List<Comment> getComments(Long postid){
        List<Comment>  comments = commentRepository.findAllByPostId(postid).orElseThrow(()-> new RuntimeException("게시물이 존재하지 않습니다."));
